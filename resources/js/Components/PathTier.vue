...
.path-tier__subtitle { font-size: 13px; color: var(--pt-text-muted, #6B5A3E); margin: 4px 0 0; }
.path-tier__chevron { font-size: 20px; color: var(--pt-text-light, #8C7A5E); transition: transform .2s; }
