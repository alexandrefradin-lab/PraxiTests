    ...
    <AdminLayout>
        ...
        <form @submit.prevent="submit" class="grid lg:grid-cols-3 gap-6">
            <section class="pt-card p-6 lg:col-span-2 space-y-5">
                ...
                <div>
                    <label class="pt-label">Version texte (fallback)</label>
            ...
            <aside class="pt-card p-6 space-y-4 h-fit">
                ...
                <div>
                    <label class="pt-label">Envoi programmé</label>
                    <input type="datetime-local" v-model="form.scheduled_at" class="pt-input mt-1">
                </div>

                <h3 class="font-semibold mt-6" style="color:var(--text-primary);font-family:var(--font-display)">Variantes A/B (optionnel)</h3>
                <textarea
                ...
                <h3 class="font-semibold mt-6" style="color:var(--text-primary);font-family:var(--font-display)">Filtre audience</h3>
                <textarea
