...
<template>
    <CandidateLayout>
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <Link :href="route('praxilead.index')" class="text-sm" style="display: inline-block; margin-bottom: 1.25rem; color: var(--text-secondary); text-decoration: none;">
                ← Le parcours
            </Link>
            ...
            <MarkdownText :source="props.practice.body" class="praxilead-prose mt-6" />
            ...
            <div class="mt-8 flex items-center justify-between" style="font-size: 0.9rem;">
                ...
                >Jour {{ nav.next }} →</Link>
                <span v-else style="font-size: 0.82rem; color: var(--text-secondary);">La prochaine pratique se débloque demain 🌙</span>
            </div>
...
<style scoped>
.praxilead-prose :deep(h2) { font-family: var(--font-display); font-weight: 700; font-size: 1.25rem; margin: 1.6rem 0 0.6rem; color: var(--text-primary); }
.praxilead-prose :deep(h3) { font-family: var(--font-display); font-weight: 700; font-size: 1.05rem; margin: 1.2rem 0 0.4rem; color: var(--text-primary); }
.praxilead-prose :deep(p) { margin: 0.6rem 0; }
.praxilead-prose :deep(ul), .praxilead-prose :deep(ol) { margin: 0.6rem 0 0.6rem 1.25rem; }
.praxilead-prose :deep(li) { margin: 0.3rem 0; }
.praxilead-prose :deep(strong) { color: var(--text-primary); }
</style>
