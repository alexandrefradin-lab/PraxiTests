...
return new class extends Migration
{
    ...
    {
        Schema::create('mgmt_practice_progress', function (Blueprint $table) {
            $table->id();
            $table->foreignId('user_id')->constrained()->cascadeOnDelete();
            $table->unsignedSmallInteger('day_index');       // 1..60
            $table->timestamp('completed_at')->nullable();   // « pratique appliquée »
    ...
    {
        Schema::dropIfExists('mgmt_practice_progress');
    }
};
