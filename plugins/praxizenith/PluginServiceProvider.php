...
namespace Praxis\Plugins\PraxiZenith;
...
class PluginServiceProvider extends AbstractPlugin
{
    ...
    public function onActivate(): void
    {
        \Artisan::call('migrate', [
            '--path'  => 'plugins/praxizenith/database/migrations',
            '--force' => true,
        ]);

        \Artisan::call('db:seed', [
            '--class' => 'Praxis\\Plugins\\PraxiZenith\\Database\\Seeders\\FocusExercisesSeeder',
            '--force' => true,
        ]);
    }
}
