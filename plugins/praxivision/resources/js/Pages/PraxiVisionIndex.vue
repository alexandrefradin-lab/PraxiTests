...
<template>
    <CandidateLayout>
        <Head :title="isCorporate ? 'Leadership — programme 60 jours' : 'L\'Eveilleur - 60 jours de leadership integral'" />

        <div class="pv-shell">

            <div class="pv-topbar">
                <div class="pv-topbar-left">
                    <div class="pv-app-name">{{ appName }}</div>
            ...
            <p v-if="appDescription" class="pv-app-desc">{{ vouvoyer(appDescription) }}</p>
...
.pv-app-desc { font-size: 0.9rem; line-height: 1.65; color: var(--text-secondary); background: var(--bg-elevated, #fafafa); border-left: 3px solid var(--color-primary, #B87A1A); border-radius: 0 10px 10px 0; padding: 0.9rem 1.1rem; margin: 0 0 1.25rem; }
