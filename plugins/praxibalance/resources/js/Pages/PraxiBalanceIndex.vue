...
const startLevel = (level) => {
    ...
    run.value = {
        ...
        pending: null,
        last6: [],
        missed: [],                   // tâches mal triées, listées en fin de série
        drag: 0,
        stamp: null,
    }
    ...
    <CandidateLayout>
        <div class="guet">
            ...
            <section v-else class="bal-result ac-fade-in">
                ...
                <!-- Ce qui a été mal trié, avec la raison : c'est la partie utile
                     d'une série ratée, et la seule qu'on relit vraiment. -->
                <section v-if="result.missed && result.missed.length" class="bal-recap">
                    <h2>Ce qui a été mal trié</h2>
                    <ul>
...
/* La tâche rappelée dans le panneau : citée, donc en retrait typographique. */
.bal-fb-task {
    font-size: 13px; color: var(--text-muted); font-style: italic;
    margin: 0 0 10px; line-height: 1.5;
}

/* Récapitulatif de fin de série : ce qui a été mal trié, et pourquoi. */
