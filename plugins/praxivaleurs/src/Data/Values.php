...
class Values
{
    ...
    public static function dimensions(): array
    {
        return [
            ...
            'conformite'    => ['label'=>'Conformité',    'color'=>'#16A085', 'court'=>'Respect des règles, discipline, fiabilité',             'definition'=>"Volonté de respecter les normes, les règles et les attentes sociales. Valorise la discipline, la maîtrise de soi et le respect des engagements pris."],
